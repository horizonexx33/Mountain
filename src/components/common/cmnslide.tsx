...
const cmnSlide = ({header, titleClassname}: HeaderWidgetProps)=>{
    ...
    return (
        ...
        {(title || subtitle || highlight) && (
          <div
            className={`mb-6 max-w-3xl text-right ${
              position === 'left' ? 'sm:text-right' : position === 'right' ? 'sm:text-right' : 'sm:text-center'
            } md:mx-auto md:mb-12`}
          >
            {highlight && (
