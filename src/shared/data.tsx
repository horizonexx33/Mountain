...
export const heroData: HeroProps = {
  player:(
    <div className='brightness-100 drop-shadow-md md:drop-shadow-xl  '>
    <video className="w-full h-[700px] object-cover block align-top leading-none" src="../assets/video/mountains.mp4" autoPlay muted loop></video>
  </div>                         
  ),
  ...
  title: (
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white">
      Mountain <br/> 
      {/* <span className="hidden md:inline"> publish your site</span>  */}
      {/* <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-blue-500">Next.js</span> +{' '} */}
      <span className="sm:whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-blue-500">with AI in seconds.</span>
